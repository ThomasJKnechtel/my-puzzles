...
export default function Share({puzzleId, socket, username, token}){
    ...
    <div  className="border-2 border-slate-500 bg-white p-1 rounded-md hover:bg-slate-50  focus-within:ring-2 group w-[50px] h-[50px] inline-flex flex-col items-center gap-1 ">
    <button type="button" >
